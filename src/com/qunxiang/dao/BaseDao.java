...
public interface BaseDao<T extends Serializable>{
	 ...
	 * @return
	 */
	List<T> findByPageDesc(PageDesc pageDesc, String propertyName);
	 ...
	 * @return
	 */
	List<T> findByPageDesc(List<String> propertyName, List<Object> value,List<String> orderPropertyName, List<String> order,PageDesc pageDesc);
	/**
	 * 根据条件读取记录并排序
	 * @param <T>
	 * @param targetName
	 ...
	 * @return
	 */
	List<T> findByPropertyListAndOrder(List<String> propertyName, List<Object> value,List<String> orderPropertyName, List<String> order,Integer pageSize);
}
